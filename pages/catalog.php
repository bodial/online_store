...
?>
	...
	<form action="catalog.php" method="GET">
		...
		<p>
			<input style="width: 300px; type="text" name="search" value=<?php if (isset($_GET['search'])) echo $_GET['search'] ?> >
...
<?php
		...
		if (isset($_GET['search']))
		{
			...
			{
				echo 'Категории с "' . $search . '" не найдены<br>';
			}
			if (!search_instrument_table($link, $search))
			{
...
<?php
					...
					elseif(($_SESSION['logged_user_id']) and ($_SESSION['logged_user_id'] == "18"))
					{
						echo 'Зачем нажал?';
					}
					else
